...
saxpyCuda(int N, float alpha, float* xarray, float* yarray, float* resultarray) {
    ...
    //
    double startSaxpy = CycleTimer::currentSeconds();
    ...
    double endSaxpy = CycleTimer::currentSeconds();
    ...
    double overallExecution = endSaxpy - startSaxpy;
    printf("Execution time: %.3f ms\n", 1000.f*overallExecution);
